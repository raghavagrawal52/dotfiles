...
local function goto_definition()
	...
	lsp.buf_request(0, 'textDocument/definition', params, function(_, result)
...
return {
	...
	config = function()
		...
		-- Set up client capabilities from Blink, but disable snippet support
		...
		-- Set up mason-lspconfig and connect each server with the modified capabilities
